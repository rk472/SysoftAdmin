...
public class AddNewsActivity extends AppCompatActivity {
        ...
        uploadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(name) || TextUtils.isEmpty(desc)){
                    Toast.makeText(AddNewsActivity.this, "You must fill all the fields.....", Toast.LENGTH_SHORT).show();
                }else{
                    m=new HashMap();
                    m.put("news_desc",desc);
                    m.put("news_title",name);
                    CropImage.activity()
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        StorageReference storeProfileImage= FirebaseStorage.getInstance().getReference().child("News");
            ...
            if (resultCode == RESULT_OK) {
                ...
                uploadTask.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> thumb_task) {
                        ...
                        DatabaseReference db= FirebaseDatabase.getInstance().getReference().child("news").child("other_news");
                        m.put("news_pic",thumb_downloadUrl);
                        db.push().updateChildren(m).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@android.support.annotation.NonNull Task<Void> task) {
                                loadingBar.dismiss();
                                Toast.makeText(AddNewsActivity.this, "Successfully Uploaded...", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
                ...
                Toast.makeText(AddNewsActivity.this,error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }
    }
}